...
static struct power_suspend interactivex_powers_suspend = {
		...
		unsigned int event)
{
	...
	case CPUFREQ_GOV_START:
		...
		enabled = 1;
		registration = 1;
                register_power_suspend(&interactivex_powers_suspend);
		registration = 0;
	...
	case CPUFREQ_GOV_STOP:
		...
		enabled = 0;
                unregister_power_suspend(&interactivex_powers_suspend);
