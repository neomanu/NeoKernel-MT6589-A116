...
static struct power_suspend lulzactive_powers_suspend = {
...
void start_lulzactiveq(void)
{
	...
	register_power_suspend(&lulzactive_powers_suspend);
}
...
void stop_lulzactiveq(void)
{
	...
	unregister_power_suspend(&lulzactive_powers_suspend);
