...
#ifdef CONFIG_POWERSUSPEND
static struct power_suspend cpufreq_gov_power_suspend;
...
#ifdef _LIMIT_LCD_OFF_CPU_MAX_FREQ_
#ifdef CONFIG_POWERSUSPEND
static void cpufreq_gov_suspend(struct power_suspend *h)
{
...
static void cpufreq_gov_resume(struct power_suspend *h)
{
...
static int __init cpufreq_gov_dbs_init(void)
{
	...
	cpufreq_gov_power_suspend.suspend = cpufreq_gov_suspend;
	cpufreq_gov_power_suspend.resume = cpufreq_gov_resume;
	register_power_suspend(&cpufreq_gov_power_suspend);
#endif
#endif
